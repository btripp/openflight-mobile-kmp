 ...
 * one `composable<Route>` line hosting that feature's `:ui` module route. The Session screen
 * (shared `SessionViewModel`) gets its destination with its UI in step R5b.
 */
@Composable
